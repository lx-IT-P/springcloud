...
import com.macro.mall.portal.domain.UmsRegisterParam;
import com.macro.mall.portal.service.FeignGradeService;
...
public class UmsMemberServiceImpl implements UmsMemberService {
    ...
    @Autowired
    private FeignGradeService feignGradeService;
    ...
    public UmsMember getByUsername(String username) {
        Assert.notNull(username,ExceptionEnum.MEMBER_NOT_FOUND);
    ...
    public void register(UmsRegisterParam umsRegisterParam) {
        ...
        umsMember.setPassword(passwordEncoder.encode(umsRegisterParam.getPassword()));
        ...
        stringStringZSetOperations.add("userScore", String.valueOf(umsMember.getId()), 2);
        //回调获取用户的闯关单词
        feignGradeService.putWord(String.valueOf(umsMember.getId()));
    ...
    public String generateAuthCode(String telephone) {
        ...
        //将手机号和验证码存入缓存
        Map<String, String> msg = new ConcurrentHashMap<>();
        msg.put("phone", telephone);
        msg.put("code", sb.toString());
        //发送信息给mq
        this.amqpTemplate.convertAndSend("mall.sms.exchange", "sms.verify.code", msg);
        LOGGER.info("已经将验证码{}发送mq",sb.toString());
        //验证码绑定手机号并存储到redis
    ...
    public String login(String username, String password) {
        ...
        //密码需要客户端加密后传递
            ...
            Assert.notNull(token,ExceptionEnum.UNLOGIN);
            LOGGER.warn("登录异常:{}", ExceptionEnum.UNLOGIN.getMsg());
        return token;
    }
